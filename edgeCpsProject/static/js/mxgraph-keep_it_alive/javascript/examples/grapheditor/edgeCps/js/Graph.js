...
{
	mxGraph.call(this, container, model, renderHint, stylesheet); // 민수 아래 함수들은 좌측 사이드메뉴 미리보기 생성
...
(function()
{
	...
	mxGraphView.prototype.validate = function(cell)
	{
		...
		graphViewValidate.apply(this, arguments); // 민수 찾는중 .. 여기에 생성 
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		 ...
		 * 
		 */
		Graph.prototype.getCenterInsertPoint = function(bbox) // 민수 지오메트리로 크기 생성하면 가운데 센터값 가져오는 곳
		{
